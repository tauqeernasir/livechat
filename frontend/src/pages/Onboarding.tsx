            ...
            {[1, 2].map((i) => (
              <div 
                ...
                className={`h-1.5 rounded-full transition-all duration-500 ${
                  step >= i ? 'w-8 bg-indigo-600' : 'w-2 bg-slate-800'
                }`} 
              />
            ))}
          </div>
        ...
        {step === 1 && (
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 lg:p-12 shadow-2xl">
            <div className="mb-8">
              ...
              <p className="text-slate-400 text-lg">Tell us about your organization to get started.</p>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-950 border border-slate-800 rounded-xl py-4 pl-12 pr-4 text-white focus:outline-none focus:ring-2 focus:ring-indigo-600 transition-all"
        ...
        {step === 2 && (
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 lg:p-12 shadow-2xl">
            <div className="mb-8">
              ...
              <p className="text-slate-400 text-lg">Workspaces help you group agents by department or project.</p>
            </div>
            ...
            <form onSubmit={handleCreateWorkspace} className="space-y-6">
              <div>
                ...
                <div className="relative">
                  <Layout className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-500" />
                  <input
                    type="text"
                    required
                    value={wsName}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="w-full bg-slate-950 border border-slate-800 rounded-xl py-4 pl-12 pr-4 text-white focus:outline-none focus:ring-2 focus:ring-indigo-600 transition-all appearance-none"
                  >
              ...
              <div className="pt-4 flex gap-4">
                <button
                  type="button"
                  onClick={() => setStep(1)}
                  className="flex-shrink-0 bg-slate-800 hover:bg-slate-700 text-white font-semibold p-4 rounded-xl transition-all"
                >
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="flex-grow bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white font-semibold py-4 rounded-xl shadow-lg shadow-indigo-600/20 transition-all flex items-center justify-center gap-2 group"
                >
                  {loading ? (
                    <Loader2 className="w-5 h-5 animate-spin" />
                  ) : (
