    ...
    <Layout>
      <div className="flex flex-col gap-8">
        <header className="flex items-end justify-between">
          <div>
            ...
            <p className="text-slate-400">Manage the data your AI agents use to answer questions.</p>
          </div>
          <div className="flex gap-3">
            ...
            <button 
              ...
              className="flex items-center gap-2 bg-slate-800 hover:bg-slate-700 text-white px-5 py-2.5 rounded-xl font-medium transition-all border border-slate-700/50 disabled:opacity-50"
            >
        ...
        <div className="bg-slate-900/50 border border-slate-800 rounded-3xl overflow-hidden backdrop-blur-sm">
          {isLoading ? (
              ...
              <tbody className="divide-y divide-slate-800/50">
                {filteredSources.map((source) => (
                  <tr key={source.id} className="hover:bg-slate-800/30 transition-colors group">
                    ...
                    <td className="px-6 py-5">
                      <span className="text-xs font-medium text-slate-400 capitalize">{source.source_type}</span>
                    </td>
                    <td className="px-6 py-5">
            ...
            <div className="p-20 flex flex-col items-center justify-center text-center">
              ...
              <h3 className="text-xl font-bold text-white mb-2">No data sources found</h3>
      ...
      {isManualModalOpen && (
        <div className="fixed inset-0 z-50 overflow-hidden">
          <div className="absolute inset-0 bg-slate-950/80 backdrop-blur-sm transition-opacity" onClick={() => setIsManualModalOpen(false)} />
            ...
            <div className="w-screen max-w-2xl transform transition-all">
              <div className="h-full flex flex-col bg-slate-900 border-l border-slate-800 shadow-2xl">
                <header className="p-6 border-b border-slate-800 flex items-center justify-between">
                  <div>
                    <h2 className="text-xl font-bold text-white">Add Manual Knowledge</h2>
                    <p className="text-sm text-slate-500">Create custom instructions or policies.</p>
                  </div>
                  <button onClick={() => setIsManualModalOpen(false)} className="p-2 text-slate-400 hover:text-white transition-colors">
                ...
                <div className="flex-grow overflow-y-auto p-6 space-y-6">
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-slate-300">Entry Name</label>
                    <input 
                      type="text" 
