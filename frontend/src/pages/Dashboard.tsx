...
export default function Dashboard() {
  ...
  return (
    <Layout>
      ...
      <div className="bg-slate-900/50 border border-slate-800 rounded-3xl p-16 flex flex-col items-center text-center backdrop-blur-sm">
        ...
        <h2 className="text-2xl font-bold text-white mb-3">Create your first chatbot</h2>
        <p className="text-slate-400 max-w-sm mb-10 text-lg">
    ...
    <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 backdrop-blur-sm">
      ...
      <div className="flex items-end justify-between">
        ...
        <span className={`text-[11px] font-bold px-2.5 py-1 rounded-lg ${
          change.startsWith('+') ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/10' : 'bg-slate-800 text-slate-400'
        }`}>
          {change}
        </span>
      </div>
